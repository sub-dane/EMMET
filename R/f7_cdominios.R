...
f7_cdominios<-function(directorio,ani,mes){
  ...
  #data<-read_excel("D:/Documentos/CAMILA/DANE/Piloto_Github/Funciones_alternas/COMPLETO SEGUNDO CIERRE DICIEMBRE 2023 definitiva.xlsx")
  ...
  Salida<-paste0(directorio,"/results/S5_anexos/anexos_cuadros_emmet_",meses[mes],".xlsx")
  ...
  prod_cont["DIFERENCIA_prod"] <- prod_cont[,(ncol(prod_cont)-1)]-prod_cont[,ncol(prod_cont)]
  ...
  vent_cont["DIFERENCIA"] <- vent_cont[,(ncol(vent_cont)-1)]-vent_cont[,ncol(vent_cont)]
  ...
  emp_cont["DIFERENCIA"] <- emp_cont[,(ncol(emp_cont)-1)]-emp_cont[,ncol(emp_cont)]
