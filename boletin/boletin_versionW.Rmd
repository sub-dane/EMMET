...
meses_m <- c("enero","febrero","marzo","abril","mayo","unio","julio","agosto","septiembre","octubre","noviembre","diciembre")

mes <- 3
anio <- 2024
directorio <- "D:/Documentos/CAMILA/DANE/Piloto_Github/ReporteNOVIEMBRE/Prueba_actualizacion"
...
ggplot(variaciones,aes(x=variable,y=variacion,fill=variable))+geom_bar(stat="identity")+
  ...
  scale_fill_manual(values = colores)+theme(legend.position = "none",axis.text.x=element_text(size=7),axis.text.y = element_text(size=6.5))+labs(y="Variacion (%)",x="",y.size=5)+
...
**`r paste0("Evolución general de las principales variables total nacional  ",meses_b[params$month]," ",params$year)`**
...
**Total Nacional**\
**`r paste0(meses_b[params$month]," ",params$year-1," - ",meses_m[params$month]," ",params$year,"p")`**\
...
variaciones_totales$variables <-
  factor(variaciones_totales$variables,levels=c("varprod","varventas","varpersonas"),
         labels=c("Produccion Real","Ventas Reales","Personal Ocupado"))
...
variaciones_totales <- variaciones_totales %>%
  filter((ANIO == params$year-1 & MES >=params$month)
| (ANIO == params$year & MES %in% c(1:params$month))) %>%
  arrange(periodo)

variaciones_totales <- na.omit(variaciones_totales)
...
ggplot(data=variaciones_totales,aes(x=periodo,y=value,group=variables,color=variables))+
  ...
  scale_color_manual(values = colores)+labs(x="",y="Variacion (%)",color="")+
  ...
  geom_text(data=variaciones_totales[variaciones_totales$periodo%in%paste0(meses[params$month],"-",substr(params$year,3,4)) & variaciones_totales$variables=="Produccion Real",],aes(x=periodo,y=0.15,label=round(value*100,1),color=variables),show.legend = F,hjust=-0.2,size=3.5)+
...
`r if(sum(tabla2$varprod>0)==0){a <- paste0("Las 39 actividades industriales representadas por la encuesta presentaron una variación positiva, sumando", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," p.p. a la variación total anual. (Tabla 1)")}else if (sum(tabla2$varprod<0)==0){a <- paste0("Las 39 actividades industriales representadas por la encuesta presentaron una variación negativa, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod>0]),1))," p.p. a la variación total anual. (Tabla 1)")}else if(sum(tabla2$produccion)>0){ a <- paste0("De las 39 actividades industriales representadas por la encuesta, un total de ", sum(tabla2$varprod>0), " registraron variaciones positivas en su producción real, sumando ", round(sum(tabla2$produccion[tabla2$varprod>0]),1), " p.p. a la variación total anual y ",sum(tabla2$varprod>0)," subsectores con variaciones negativas restaron en conjunto " ,abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," puntos porcentuales a la variación total. (Tabla 1).")}else if(sum(tabla2$produccion)<=0){a <- paste0("De las 39 actividades industriales representadas por la encuesta, un total de ", sum(tabla2$varprod<0), " registraron variaciones negativas en su producción real, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1)), " p.p. a la variación total anual y ",sum(tabla2$varprod>0)," subsectores con variaciones positivas sumaron en conjunto ",round(sum(tabla2$produccion[tabla2$varprod>0]),1)," puntos porcentuales a la variación total. (Tabla 1).")}`

`r a `

<!-- De las 39 actividades industriales representadas por la encuesta, un total de `r paste0(sum(tabla2$varprod>=0))` registraron variaciones positivas en su producción real, sumando `r paste0(sum(tabla2$produccion[tabla1$varprod>=0]))` puntos porcentuales a la variación total anual y `r paste0(sum(tabla2$varprod<0))` subsectores con variaciones negativas restaron en conjunto `r abs(sum(tabla2$produccion[tabla2$varprod<0]))` puntos porcentuales a la variación total (Tabla 1). -->

**Tabla 1. Variación anual y contribución de la producción real, ventas reales y personal ocupado, según actividad manufacturera**\
**Total nacional **\
**`r paste0(meses_b[params$month]," (", params$year,"/",params$year-1,")p") `**
...
**`r paste0("Enero - ",meses_m[params$month],"", params$year,"/",params$year-1,"p")`**
...
`r if(sum(tabla2$varprod>0)==0){a <- paste0("Las 39 actividades industriales representadas por la encuesta presentaron una variación positiva, sumando", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," p.p. a la variación total anual. (Tabla 1)")}else if (sum(tabla2$varprod<0)==0){a <- paste0("Las 39 actividades industriales representadas por la encuesta presentaron una variación negativa, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod>0]),1))," p.p. a la variación total anual. (Tabla 1)")}else if(sum(tabla2$produccion)>0){ a <- paste0("De las 39 actividades industriales representadas por la encuesta, un total de ", sum(tabla2$varprod>0), " registraron variaciones positivas en su producción real, sumando ", round(sum(tabla2$produccion[tabla2$varprod>0]),1), " p.p. a la variación total anual y ",sum(tabla2$varprod>0)," subsectores con variaciones negativas restaron en conjunto " ,abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," puntos porcentuales a la variación total. (Tabla 2).")}else if(sum(tabla2$produccion)<=0){a <- paste0("De las 39 actividades industriales representadas por la encuesta, un total de ", sum(tabla2$varprod<0), " registraron variaciones negativas en su producción real, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1)), " p.p. a la variación total anual y ",sum(tabla2$varprod>0)," subsectores con variaciones positivas sumaron en conjunto ",round(sum(tabla2$produccion[tabla2$varprod>0]),1)," puntos porcentuales a la variación total. (Tabla 2).")}`

`r a `

**Tabla 2. Variación año corrido y contribución de la producción real, ventas reales y personal ocupado, según actividad manufacturera**\
**Total nacional**\
**`r paste0("Enero - ",meses_m[params$month]," (", params$year,"/",params$year-1,")p")`**
...
**`r paste0(meses_b[params$month+1]," ",params$year-1," - ",meses_m[params$month]," ", params$year," / ",meses_m[params$month+1]," ",params$year-2," - ",meses_m[params$month]," ", params$year-1,"P")`**\
...
variaciones_totales <- variaciones_totales %>% 
  filter((ANIO>=params$Anio_grafico & MES >= params$month) | (ANIO==params$Anio_grafico & MES %in% 1:params$month) )

```



Durante los últimos doce meses hasta `r paste0(meses_m[params$month]," de ",params$year)`, la producción real de la industria manufacturera presentó una variación de `r paste0(round(variaciones_totales[variaciones_totales$periodo%in%paste0(meses[params$month],"-",substr(params$year,3,4)) & variaciones_totales$variables=="Producción Real","value"]*100,1),"%")`, las ventas reales de `r paste0(round(variaciones_totales[variaciones_totales$periodo%in%paste0(meses[params$month],"-",substr(params$year,3,4)) & variaciones_totales$variables=="Ventas Reales","value"]*100,1),"%")` y el personal ocupado de `r paste0(round(variaciones_totales[variaciones_totales$periodo%in%paste0(meses[params$month],"-",substr(params$year,3,4)) & variaciones_totales$variables=="Personal Ocupado","value"]*100,1),"%")`.\
...
`r if(sum(tabla2$varprod>0)==0){a <- paste0("Las 39 actividades industriales representadas por la encuesta presentaron una variación positiva, sumando", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," p.p. a la variación total anual. (Tabla 1)")}else if (sum(tabla2$varprod<0)==0){a <- paste0("Las 39 actividades industriales representadas por la encuesta presentaron una variación negativa, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod>0]),1))," p.p. a la variación total anual. (Tabla 1)")}else if(sum(tabla2$produccion)>0){ a <- paste0("De las 39 actividades industriales representadas por la encuesta, un total de ", sum(tabla2$varprod>0), " registraron variaciones positivas en su producción real, sumando ", round(sum(tabla2$produccion[tabla2$varprod>0]),1), " p.p. a la variación total anual y ",sum(tabla2$varprod>0)," subsectores con variaciones negativas restaron en conjunto " ,abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," puntos porcentuales a la variación total. (Tabla 3).")}else if(sum(tabla2$produccion)<=0){a <- paste0("De las 39 actividades industriales representadas por la encuesta, un total de ", sum(tabla2$varprod<0), " registraron variaciones negativas en su producción real, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1)), " p.p. a la variación total anual y ",sum(tabla2$varprod>0)," subsectores con variaciones positivas sumaron en conjunto ",round(sum(tabla2$produccion[tabla2$varprod>0]),1)," puntos porcentuales a la variación total. (Tabla 3).")}`
...
`r if(sum(tabla2$varprod>0)==0){a <- paste0("Los 14 dominios de departamentos representados por la encuesta, registraron variaciones negativas en su producción real, sumando ", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," p.p. a la variación total nacional.")}else if (sum(tabla2$varprod<0)==0){a <- paste0("Los 14 dominios de departamentos representados por la encuesta, registraron variaciones positivas en su producción real, sumando ", abs(round(sum(tabla2$produccion[tabla2$varprod>0]),1))," p.p. a la variación total nacional.")}else if(sum(tabla2$produccion)>0){ a <- paste0("De los 14 dominios de departamentos representados por la encuesta, ", sum(tabla1$varprod>0), " registraron variaciones positivas en su producción real, sumando ", round(sum(tabla2$produccion[tabla2$varprod>0]),1), " p.p. a la variación total nacional.")}else if(sum(tabla2$produccion)<=0){a <- paste0("De los 14 dominios de departamentos representados por la encuesta, ", sum(tabla2$varprod<0), " registraron variaciones negativas en su producción real, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1)), " p.p. a la variación total nacional.")}`
...
tabla2 <- tabla1 %>% 
  filter(substr(AREA_METROPOLITANA,1,3)!="Res")
...
`r if(sum(tabla2$varprod)>=0){a <- paste0("En ", tolower(meses_b[params$month])," de ",params$year," frente a ", tolower(meses_b[params$month])," ",params$year-1,", el área metropolitana que más constribuye a la variación anual de la producción real es la de ",tabla2$AREA_METROPOLITANA[which.max(tabla2$produccion)]," con una variación de ", round(tabla2$varprod[which.max(tabla2$produccion)],1),"%, sumando ", round(abs(tabla2$produccion[which.max(tabla2$produccion)]),1)," p.p. a la variación total nacional (",round(sum(tabla1$produccion),1),"%).")}else if (sum(tabla1$varprod)<=0){a <- paste0("En ", tolower(meses_b[params$month])," de ",params$year," frente a ", tolower(meses_b[params$month])," ",params$year-1,", el área metropolitana que más constribuye a la variación anual de la producción real es la de ",tabla2$AREA_METROPOLITANA[which.min(tabla2$produccion)]," con una variación de ", round(tabla2$varprod[which.min(tabla2$produccion)],1),"%, sumando ", round(abs(tabla2$produccion[which.max(abs(tabla2$produccion))]),1)," p.p. a la variación total nacional(",round(sum(tabla1$produccion),1),"%).")}`
...
`r if(sum(tabla2$varprod)==0){a <- paste0("En ", paste0(tolower(meses_b[params$month])," de ",params$year)," frente a ", paste0(tolower(meses_b[params$month])," de ",params$year-1),", los 10 dominios de ciudades representados por la encuesta, registraron variaciones negativas en su producción real, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," p.p. de la variación total nacional (Tabla 6)")}else if ( sum(tabla2$produccion)<0){a <- paste0("En ", tolower(meses_m[params$month])," de ",params$year," frente a ", tolower(meses_m[params$month])," de ",params$year-1,", de los 10 dominios de ciudades representados por la encuesta, ", sum(tabla2$varprod<0)," registraron variaciones negativas en su producción real, restando ", abs(round(sum(tabla2$produccion[tabla2$varprod<0]),1))," p.p. de la variación total nacional (Tabla 6)")}else if(sum(tabla2$produccion)>=0){a <- paste0("En ", tolower(meses_b[params$month])," de ",params$year," frente a ", tolower(meses_b[params$month])," de ",params$year-1,", de los 10 dominios de ciudades representados por la encuesta, ", sum(tabla2$varprod>0)," registraron variaciones positivas en su producción real, sumando ", abs(round(sum(tabla2$produccion[tabla2$varprod>0]),1))," p.p. de la variación total nacional (Tabla 6)")}`
...
`r if(sum(tabla2$varprod)>=0){a <- paste0("En lo corrido del año hasta ", tolower(meses_b[params$month])," ",params$year,", el área metropolitana que más constribuye de manera positiva a la variación anual de la producción real es la del ",tabla2$AREA_METROPOLITANA[which.max(tabla2$produccion)]," con una variación de ", round(tabla2$varprod[which.max(tabla2$produccion)],1),"%, sumando ", round(abs(tabla2$produccion[which.max(tabla2$produccion)]),1)," p.p. a la variación total nacional  ",round(sum(tabla1$produccion),1),"% (Tabla 8).")}else if (sum(tabla1$varprod)<=0){a <- paste0("En lo corrido del año hasta ", tolower(meses_b[params$month])," ",params$year,", el área metropolitana que más constribuye a la variación anual de la producción real es la del ",tabla2$AREA_METROPOLITANA[which.min(tabla2$produccion)]," con una variación de ", round(tabla2$varprod[which.min(tabla2$produccion)],1),"%, restando ", round(abs(tabla2$produccion[which.max(abs(tabla2$produccion))]),1)," p.p. a la variación total nacional ",round(sum(tabla1$produccion),1),"% (Tabla 8).")}`
...
**`r paste0(ifelse(meses_b[params$month]=="Diciembre",paste0("Enero ",params$year),paste0(meses_m[params$month+1]," ",params$year-1))," - ",meses_m[params$month]," ",params$year,"/",ifelse(meses_b[params$month]=="Diciembre",paste0("Enero ",params$year),paste0(meses_m[params$month+1]," ",params$year-2))," - ",meses_m[params$month]," ",params$year-1,"P")`**\
...
## Variación doce meses (\%) y contribución, del valor de la producción, ventas, y empleo total, según áreas metropolitanas {.unlisted }
**`r paste0(ifelse(meses_b[params$month]=="Diciembre",paste0("Enero ",params$year),paste0(meses_b[params$month+1]," ",params$year-1))," - ",meses_b[params$month]," ",params$year,"/",ifelse(meses_b[params$month]=="Diciembre",paste0("Enero ",params$year),paste0(meses_b[params$month+1]," ",params$year-2))," - ",meses_b[params$month]," ",params$year-1,"P")`**\
...
`r if(sum(tabla2$produccion)<=0){a <- paste0("Durante los últimos doce meses hasta el mes de ", tolower(meses_b[params$month])," de ",params$year,", el área metropolitana que más constribuye de manera negativa a la variación anual de la producción real es la del ", tabla2$AREA_METROPOLITANA[which.min(tabla2$produccion)]," con una variación de ", round(tabla2$varprod[which.min(tabla2$produccion)],1),"%, restando ", round(tabla2$produccion[which.min(tabla2$varprod)],1)," p.p. a la variación total nacional ",sum(tabla1$produccion) ," (Tabla 11)")}else if(sum(tabla2$varprod)>0){a <- paste0("Durante los últimos doce meses hasta el mes de ",tolower(meses_b[params$month])," de ",params$year,", el área metropolitana que más constribuye de manera positiva a la variación anual de la producción real es la de ", tabla2$AREA_METROPOLITANA[which.max(tabla2$varprod)]," con una variación de ", round(tabla2$varprod[which.max(tabla2$varprod)],1),"%, sumando ", round(tabla2$produccion[which.max(tabla2$varprod)],1)," p.p. a la variación total nacional ", sum(tabla1$produccion) ," (Tabla 11)")}`
